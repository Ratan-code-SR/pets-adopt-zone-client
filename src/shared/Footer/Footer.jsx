        ...
        <footer className="bg-gray-900 p-10 font-sans tracking-wide">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="lg:flex lg:items-center">
                   <p className="text-white">PetAdoptZone</p>
                </div>
                ...
                <div className="lg:flex lg:items-center">
                    <ul className="flex space-x-6">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/shakyo-ratan-chakma-2b5672292/">
                                <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-300 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="https://twitter.com/x/migrate?tok=7b2265223a222f526174616e43683639363537373235222c2274223a313731383037383934397d89a384b8779d8a493c4e57778a550723">
            ...
            <div className="flex justify-between items-center">
                <p className='text-gray-300 text-sm mt-10'>Developed by <a href='www.linkedin.com/in/shakyo-ratan-chakma' target='_blank' rel="noopener noreferrer" className="hover:underline mx-1">Ratan</a></p>
                <p className='text-gray-300 text-sm mt-10'>© 2024<a href='www.linkedin.com/in/shakyo-ratan-chakma' target='_blank' rel="noopener noreferrer" className="hover:underline mx-1">PetAdoptZone</a>All Rights Reserved.</p>
            </div>
        </footer>
