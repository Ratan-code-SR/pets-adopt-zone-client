    ...
    return (
        <div>
            ...
            <div className="flex flex-col justify-center items-center font-[sans-serif] text-[#333] lg:h-screen p-6">
                <div className="grid md:grid-cols-2 items-center gap-y-8 max-w-7xl w-full shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                    <div className="max-md:order-1 bg-[#96875d] flex flex-col justify-center sm:p-6 p-4 w-full h-full space-y-16">
                        <div
