...
const CallToAction = () => {
    return (
        <>
            <Title heading={`Adopt, Don't Shop`} />
            <Heading heading={`Ready to welcome a new furry friend into your home? Explore our database of adorable, adoptable pets waiting for their forever family. Adopt, do not shop, and give a deserving pet a loving home.`}></Heading>
